...
def verify_and_build(pio: str) -> None:
    ...
    compile_and_run("/tmp/lcd-panel-tests", ["firmware/common", "firmware/lcd-panels/include"], ["firmware/lcd-panels/src/bounded_http_logic.cpp", "firmware/lcd-panels/src/panel_lcd_logic.cpp", "firmware/lcd-panels/src/panel_logic.cpp", "firmware/lcd-panels/src/setup_http.cpp", "firmware/lcd-panels/test/native/test_main.cpp"])
